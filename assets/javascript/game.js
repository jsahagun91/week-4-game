...
$(document).ready( function() {
    ...
    //global vars
    var availableChars = [lukeSkywalker, r2d2, chewbacca, darthVader];
    var playerChar;
    var currentDefender;
    ...
    function startGame() {
        ...
        $("#lukeSkywalkerHp").text(lukeSkywalker.hp + " HP");
    ...
    function setPlayerChar() {
        /*if id of img clicked is lukeSkywalker, set player char to han solo etc*/
        ...
        switch(this.id) {
            case "lukeSkywalker": {
                playerChar = lukeSkywalker;
                $("#lukeSkywalkerHp").attr("id", "playerHp");
                removeFromAvail(lukeSkywalker);
                console.log(this);
            ...
            case "r2d2": {
                ...
                $(this).attr("class", "selected");
                $("#lukeSkywalker").attr("class", "selectableEnemy");
                $("#lukeSkywalker").appendTo(".enemyCharactersWrapper");
                $("#lukeSkywalkerHp").appendTo(".enemyCharactersWrapper");
                $("#chewbacca").attr("class", "selectableEnemy");
                $("#chewbacca").appendTo(".enemyCharactersWrapper");
                $("#chewbaccaHp").appendTo(".enemyCharactersWrapper");
                $("#darthVader").attr("class", "selectableEnemy");
    ...
    function selectEnemy() {
        if (currentDefender === undefined) {
            ...
            switch (this.id) {
                case "lukeSkywalker": {
                    currentDefender = lukeSkywalker;
                    $("#lukeSkywalker").appendTo(".defenderWrapper");
                    $("#lukeSkywalkerHp").appendTo(".defenderWrapper");
                    $("#lukeSkywalkerHp").attr("id", "defenderHp");
                }
                break;
                case "r2d2": {
